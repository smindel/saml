...
class Response extends Element
{
    ...
    {
        return (bool)$this->dom->schemaValidate(dirname(dirname(dirname(__FILE__))) . '/schema/saml-schema-protocol-2.0.xsd');
    }

    public function validateStatus()
    {
        return count($this->get('/samlp:Response/samlp:Status/samlp:StatusCode/@Value=\'urn:oasis:names:tc:SAML:2.0:status:Success\'')) == 1;
    }
